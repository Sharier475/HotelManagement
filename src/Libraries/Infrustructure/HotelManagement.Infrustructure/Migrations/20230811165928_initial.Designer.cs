...
namespace HotelManagement.Infrustructure.Migrations
{
    ...
    [Migration("20230811165928_initial")]
            ...
            modelBuilder.Entity("HotelManagement.Model.Guest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 11, 22, 59, 28, 620, DateTimeKind.Unspecified).AddTicks(9783), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            GuestName = "Shakil",
                            RoomPrice = 1200.0,
                            RoomType = "Single-Bed",
